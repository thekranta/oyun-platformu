...
- ⬜ Sirada (daha riskli, kullanici onayi gerekecek): `index.tsx` icindeki auth (girisYap, kayitOl, selectChild, sifremiUnuttum) mantigini ayri hook/servis dosyalarina cikarmak. Bu, state referanslarini (setAd, setYas, showToast, setAsama vb.) degistirmeyi gerektirdigi icin daha yuksek risk tasiyor; kucuk adimlarla devam ediliyor.
