...
export default function KumBoyasi({ onGameEnd, onExit, childName }: Props) {
  ...
  return (
    <View style={styles.container}>
      {!gameReady && (
        <CountdownOverlay
          message="Bir renk seç, parmağını sürükle ve rengarenk kum aksın!"
          childName={childName}
          countdownSeconds={5}
          interaction="draw"
      ...
      <TouchableOpacity style={styles.listenBtn} onPress={() => speak('Bir renk seç, parmağını sürükle ve rengarenk kum aksın!', { instructions: HAPPY_VOICE })} activeOpacity={0.85}>
...
const styles = StyleSheet.create({
  ...
  listenBtn: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#F57C00', paddingVertical: 10, paddingHorizontal: 20, borderRadius: 22, marginTop: 4, marginBottom: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.18, shadowRadius: 1, elevation: 3 },
