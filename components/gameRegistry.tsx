...
import AkilliToplama from './AkilliToplama';
import AkilliFarkli from './AkilliFarkli';
import AkilliCikarma from './AkilliCikarma';
import AkilliHafiza from './AkilliHafiza';
import AkilliHarf from './AkilliHarf';
...
import DunyaHaritasi from './DunyaHaritasi';
...
export const GAME_RENDERERS: Record<string, (ctx: GameRenderContext) => React.ReactNode> = {
  ...
  'dunya-haritasi': (c) => <DunyaHaritasi onGameEnd={c.onGameEnd} onExit={c.onExit} childName={c.ad} />,
