...
export const GAME_CATALOG: GameCatalogItem[] = [
  ...
  { id: 'dunya-bayraklari', title: 'Dunya Bayraklari', status: 'secondary', domain: 'Kavram', skillFocus: 'Kulturel farkindalik (Montessori) - dunya bayraklari', routeKey: 'dunya-bayraklari' },
  { id: 'dunya-selamlari', title: 'Dunya Selamlari', status: 'secondary', domain: 'Kavram', skillFocus: 'Kulturel farkindalik (Montessori) - dunya selamlari', routeKey: 'dunya-selamlari' },
