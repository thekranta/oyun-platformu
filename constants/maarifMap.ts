...
export const MAARIF_MAP: Record<string, MaarifEntry> = {
  ...
  'diziyi-tamamla-3': { displayName: 'İlk Örüntüm', alan: 'Matematik', surec: 'Matematiksel Muhakeme', cikti: 'MAB.4', ciktiAciklama: 'Karşılaştırmaya ve tahmine dayalı çıkarım yapabilme; örüntüyü kuralına uygun olarak devam ettirir (kısa dizi, 2 seçenek, giriş seviyesi)' },
