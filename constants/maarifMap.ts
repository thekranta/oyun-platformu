...
export const MAARIF_MAP: Record<string, MaarifEntry> = {
  ...
  'once-sonra': { displayName: 'Önce-Sonra', alan: 'Sosyal', surec: 'Zamanı Algılama ve Kronolojik Düşünme', cikti: 'SAB.1', ciktiAciklama: 'Günlük hayatında zaman kavramını kullanır; olayları oluş sırasına (önce-sonra) göre dizer', badgeAlan: 'Kavram (Zaman)' },
  ...
  'meslekler': { displayName: 'Meslekler', alan: 'Sosyal', surec: 'Toplumsal Yaşam', cikti: 'SAB.3', ciktiAciklama: 'Meslekleri ve toplumsal rolleri tanır; meslek-araç ilişkisi kurar', badgeAlan: 'Sosyal (Meslekler)' },
  ...
  'gunum': { displayName: 'Günüm', alan: 'Sosyal', surec: 'Zamanı Algılama ve Kronolojik Düşünme', cikti: 'SAB.1', ciktiAciklama: 'Günlük rutini zaman sırasına (sabah-akşam) koyar; zaman kavramı', badgeAlan: 'Kavram (Zaman)' },
