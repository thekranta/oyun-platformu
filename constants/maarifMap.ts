...
export const MAARIF_MAP: Record<string, MaarifEntry> = {
  ...
  'diziyi-tamamla': { displayName: 'Diziyi Tamamla', alan: 'Matematik', surec: 'Matematiksel Muhakeme', cikti: 'MAB.3', ciktiAciklama: 'Matematiksel olgu/olay/nesnelere ilişkin çıkarım yapabilme; örüntüyü kuralına uygun olarak devam ettirir' },
  'diziyi-tamamla-2': { displayName: 'Örüntü Ustası', alan: 'Matematik', surec: 'Matematiksel Muhakeme', cikti: 'MAB.3', ciktiAciklama: 'Matematiksel olgu/olay/nesnelere ilişkin çıkarım yapabilme; örüntüyü kuralına uygun olarak devam ettirir (çok şekilli, ileri seviye)' },
  ...
  'bayrak-boya': { displayName: 'Bayrak Boya', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; bayrakları örneğe göre doğru renklerle boyar, kültürel farkındalık', badgeAlan: 'Sanat / Kültür' },
  ...
  'yaratici-cizim': { displayName: 'Hayal Defteri', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; serbest çizim ve boyama ile yaratıcı ifade', badgeAlan: 'Sanat / Yaratıcı' },
  ...
  'ceviz-macera': { displayName: 'Ceviz Macerası', alan: 'Türkçe', surec: 'Dinleme/İzleme', cikti: 'TADB.2', ciktiAciklama: 'Dinledikleri/izledikleri materyaller ile ilgili yeni anlamlar oluşturabilme', deger: 'Yardımseverlik', isValueStory: true, badgeAlan: 'Sosyal-Duygusal' },
  ...
  'neredeyim': { displayName: 'Neredeyim?', alan: 'Sosyal', surec: 'Mekânsal Düşünme', cikti: 'SAB.5', ciktiAciklama: 'Nesnelerin/kişilerin konumlarını mekânsal kavramlarla ifade eder (içinde/üstünde/altında/yanında)', badgeAlan: 'Kavram (Konum)' },
  'once-sonra': { displayName: 'Önce-Sonra', alan: 'Sosyal', surec: 'Sosyal Alan / Zaman', cikti: 'SAB.2', ciktiAciklama: 'Kendisine/ailesine/bir hikâyeye ait görselleri oluş sırasına göre sıralayabilme; olayları önce-sonra sırasına dizer', badgeAlan: 'Kavram (Zaman)' },
  ...
  'gunduz-gece': { displayName: 'Gündüz mü Gece mi?', alan: 'Sosyal', surec: 'Zamanı Algılama ve Kronolojik Düşünme', cikti: 'SAB.1', ciktiAciklama: 'Zaman kavramını kullanır; nesne/olayları gündüz-gece ile ilişkilendirir', badgeAlan: 'Kavram (Zaman)' },
  ...
  'ilk-harf': { displayName: 'İlk Harf', alan: 'Türkçe', surec: 'Erken Okuryazarlık / Okuma Öncesi', cikti: 'TAEOB.5', ciktiAciklama: 'Okuma öncesi becerileri kazanabilme; harf-ses ilişkisi kurarak verilen harfle başlayan kelimeyi/görseli bulur (ilk ses farkındalığı)', badgeAlan: 'Dil (İlk Harf)' },
  ...
  'cizim-sayfalari': { displayName: 'Çizim Sayfaları', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; kılavuz çizgileri takip ederek çizgi çalışması ve el-göz koordinasyonu geliştirir', badgeAlan: 'Sanat / Çizgi Çalışması' },
  ...
  'guvende-kal': { displayName: 'Güvende Kal', alan: 'Hareket ve Sağlık', surec: 'Güvenlik', cikti: 'HSAB.11', ciktiAciklama: 'Tehlike ve kaza durumlarına karşı kendini koruyabilme; güvenli davranışı seçer', badgeAlan: 'Sağlık (Güvenlik)' },
  ...
  'meslekler': { displayName: 'Meslekler', alan: 'Sosyal', surec: 'Toplumsal Yaşam', cikti: 'SAB.20', ciktiAciklama: 'Toplumsal yaşama yönelik nesne, olgu ve olayları çözümleyebilme; meslekleri ve toplumsal rolleri tanır, meslek-araç ilişkisi kurar', badgeAlan: 'Sosyal (Meslekler)' },
  ...
  'gunum': { displayName: 'Günüm', alan: 'Sosyal', surec: 'Sosyal Alan / Zaman', cikti: 'SAB.2', ciktiAciklama: 'Kendisine ait günlük rutin görselleri oluş sırasına (sabah-akşam) göre sıralayabilme', badgeAlan: 'Kavram (Zaman)' },
  ...
  'simetri-cizim': { displayName: 'Simetri Çizim', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; serbest çizim ve el-göz koordinasyonu ile simetri sezgisi (aynalı çizim)', badgeAlan: 'Sanat / Simetri' },
  'damga-sanati': { displayName: 'Damga Sanatı', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; yaratıcı ifade ve kompozisyon, damga/çıkartma ile sahne oluşturma', badgeAlan: 'Sanat / Kompozisyon' },
  'boyama-kitabi': { displayName: 'Boyama Kitabı', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; yaratıcı ifade ve renk seçimi ile resim bölgelerini boyama (ince motor)', badgeAlan: 'Sanat / Boyama' },
  ...
  'sayi-boya': { displayName: 'Sayı-Boya', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; sayı-renk eşleştirerek boyama, renk seçimi + sayı tanıma + ince motor', badgeAlan: 'Sanat / Sayı-Boya' },
  'mandala': { displayName: 'Mandala', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; yaratıcı ifade ve radyal simetri (çizim merkez etrafında çoğalır)', badgeAlan: 'Sanat / Simetri' },
  'nokta-boyama': { displayName: 'Nokta Boyama', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; noktalarla (pointillism) yaratıcı boyama, el-göz koordinasyonu', badgeAlan: 'Sanat / Boyama' },
  'cizimi-canlandir': { displayName: 'Çizimini Canlandır', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; serbest yaratıcı çizim, çizimini canlandırarak eğlenme', badgeAlan: 'Sanat / Yaratıcı' },
  'yuz-yap': { displayName: 'Yüz Yap', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; parçalarla yüz/karakter oluşturma, parça-bütün ve yaratıcı ifade', badgeAlan: 'Sanat / Kolaj' },
  'yarisini-tamamla': { displayName: 'Yarısını Tamamla', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; simetri farkındalığıyla resmin eksik yarısını çizerek tamamlama', badgeAlan: 'Sanat / Simetri' },
  'kum-boyasi': { displayName: 'Kum Boyası', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; duyusal yaratıcı ifade, akan renklerle serbest boyama', badgeAlan: 'Sanat / Boyama' },
  'adim-adim': { displayName: 'Adım Adım Çizim', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; yönerge takibiyle adım adım çizim, el-göz koordinasyonu', badgeAlan: 'Sanat / Rehberli' },
  'sayi-boya-2': { displayName: 'Sayı-Boya 2', alan: 'Sanat', surec: 'Sanat Etkinliği Uygulama', cikti: 'SNAB.4', ciktiAciklama: 'Sanat etkinliği uygulayabilme; detaylı sayı-renk eşleştirmeli boyama (daha büyük grid, 6 renk), renk-sayı ilişkisi + ince motor', badgeAlan: 'Sanat / Sayı-Boya' },
