...
export const MAARIF_MAP: Record<string, MaarifEntry> = {
  ...
  'dunya-haritasi': { displayName: 'Kıtaları Bul', alan: 'Sosyal', surec: 'Sosyal Alan / Kültür', cikti: 'SAB.2', ciktiAciklama: 'Toplumsal yaşama yönelik kültürel unsurları çözümleyebilme; dünya haritasında kıtaları tanır ve bulur (Montessori kıta çalışması)', badgeAlan: 'Sosyal / Coğrafya' },
